...
namespace MovilBusinessApiCore.Utils
{
    public class Functions
    {
        ...
        public static void WriteLog(string RepCodigo, string mensaje, bool leer = false)
        {
            try
            {
                ...
                string filePath = string.Concat(Path + "/", DateTime.Now.ToString("dd-MM-yyyy") + "(" + RepCodigo + (leer?"-CambiosConsumidos":"")+ ").txt");
